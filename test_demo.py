...
def select_model(args, device):
    ...
    if model_id == 0:
        ...
        from models.LGVAN import LGVAN
        name, data_range = f"{model_id:02}_LGVAN", 1.0
        model_path = os.path.join('model_zoo', 'LGVAN.pth')
        model = LGVAN(num_in_ch=3,
        num_out_ch=3,
        num_feat=32,
        num_block=9,
        upscale = 4,)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_dir", default="/data/NTIRE2023_Challenge", type=str)
